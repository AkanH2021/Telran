...
public class QuickSort {
    ...
    public static void main(String[] args) {
        ...
        // partition(array, start, end) : int indexPivot -> helper method for rearrange array elements from pivot
        //swap(array, first, second) : void -> helper method for swapping two elements

        int[] array = new int[]{39, 22, 2, 55, 6, 20};
    ...
    private static void quickSort(int[] array, int start, int end) {
        if (start >= end) {  //basic case for exiting recursion
            return;
        }
